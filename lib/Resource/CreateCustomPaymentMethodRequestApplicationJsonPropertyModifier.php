...
readonly class CreateCustomPaymentMethodRequestApplicationJsonPropertyModifier implements \JsonSerializable
{
    use JsonSerializableTrait;

    private const SCHEMA = ['name' => 'CreateCustomPaymentMethodRequestApplicationJsonPropertyModifier', 'required' => [], 'properties' => ['percentage' => ['kind' => 'nullable', 'inner' => ['kind' => 'union', 'variants' => [['kind' => 'primitive', 'type' => 'string'], ['kind' => 'primitive', 'type' => 'number']]]], 'fixed' => ['kind' => 'nullable', 'inner' => ['kind' => 'union', 'variants' => [['kind' => 'primitive', 'type' => 'string'], ['kind' => 'primitive', 'type' => 'number']]]]], 'additionalProperties' => false];
