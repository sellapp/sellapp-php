...
readonly class ReplaceCustomPaymentMethodRequestApplicationJsonPropertyModifier implements \JsonSerializable
{
    use JsonSerializableTrait;

    private const SCHEMA = ['name' => 'ReplaceCustomPaymentMethodRequestApplicationJsonPropertyModifier', 'required' => [], 'properties' => ['percentage' => ['kind' => 'nullable', 'inner' => ['kind' => 'union', 'variants' => [['kind' => 'primitive', 'type' => 'string'], ['kind' => 'primitive', 'type' => 'number']]]], 'fixed' => ['kind' => 'nullable', 'inner' => ['kind' => 'union', 'variants' => [['kind' => 'primitive', 'type' => 'string'], ['kind' => 'primitive', 'type' => 'number']]]]], 'additionalProperties' => false];
